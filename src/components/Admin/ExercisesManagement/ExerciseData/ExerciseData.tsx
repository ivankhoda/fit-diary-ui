...
const useExerciseFormFields = (formData: AdminExerciseProfile | null, setFormData: SetFormData) => {
    ...
    return { handleCheckboxChange, handleGroupClick, handleInputChange };
};
...
const useExerciseDataPage = () => {
    ...
    const { handleCheckboxChange, handleGroupClick, handleInputChange } = useExerciseFormFields(formData, setFormData);

...
const ExerciseItem: React.FC<ExerciseItemProps> = ({ exercise, deleteExercise, edit }) => {
        ...
        <div className="exercise-item">
            ...
            </div>
            {
                <div className="exercise-summary">
                    ...
                    {exercise.own && <button className="show-exercise-btn" onClick={handleEdit}>
                        {t('edit')} <FontAwesomeIcon icon={faEdit} />
                    </button>}
                    {exercise.own && <button className='show-exercise-btn' onClick={onDelete}>

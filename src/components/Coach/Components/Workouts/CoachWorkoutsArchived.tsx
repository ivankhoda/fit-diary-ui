...
const UserWorkoutsArchived: React.FC<WorkoutsInterface> = ({
    ...
    useEffect(() => {
        coachWorkoutsController.getArchivedWorkouts();
    }, [coachWorkoutsController, coachWorkoutsStore]);
    ...
    const { archivedWorkouts } = coachWorkoutsStore;
                ...
                {workoutsToDisplay &&
                    workoutsToDisplay.map((workout, index) => (
                        <div key={workout.id || `workout-${index}`} className="workout-item">
                            ...
                            >
                                <CoachWorkout workout={workout} state={workout.state} />
                            </div>
...
export default inject('exercisesStore', 'exercisesController', 'coachWorkoutsStore', 'coachWorkoutsController')(
